...
export default function ProductDetails() {
  ...
  const handleBuyNow = () => {
    ...
    console.log("data in the Ui", cartData);
    dispatch(addItemToCart(cartData));
    navigate("/cart");
  };
    ...
    <div className="bg-white lg:px-21">
      ...
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          ...
          >
            {fixedProduct.breadcrumbs.map((breadcrumb) => (
        ...
        <section className=" grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 py-10">
          ...
          <div className="flex flex-col items-center">
            <div className="overflow-hidden rounded-lg max-w-[30rem] max-h-[35rem]">
              <img
                alt={fixedProduct.images[0].alt}
                src={product.product?.products?.imageUrl}
                className="h-full w-full object-cover object-center"
              />
            </div>
            <div className="flex flex-wrap space-x-5 justify-center">
              {fixedProduct.images.map((item, index) => (
                <div
                  key={index}
          ...
          <div className="overflow-hidden lg:col-span-1 max-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="flex space-x-5 items-center text-lg lg:text-xl">
                <p className="font-semibold my-6 text-gray-900">
              ...
              <div className="mt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-50 text-sm">
                    {product.product?.products?.ratings.length} Ratings
                  </p>
                  <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">
                    {product.product?.products?.reviews.length} Reviews
                  </p>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="mt-4">
                  <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                    {fixedProduct.highlights.map((highlight) => (
        ...
        <section>
          ...
          <div className="flex flex-wrap space-y-5">
            {menPants.slice(0, 15).map((index, item) => (
