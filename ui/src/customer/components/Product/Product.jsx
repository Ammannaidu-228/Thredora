...
const filters = [
  ...
  },
  {
    ...
    name: "Price",
    options: [
      { value: "100", label: "₹100 - ₹300", checked: false },
      { value: "300", label: "₹300 - ₹500", checked: false },
      { value: "500", label: "₹500 - ₹800", checked: false },
      { value: "800", label: "₹800 - ₹1000", checked: false },
      { value: "1000", label: "₹1000 - ₹1500", checked: false },
      { value: "1500", label: "₹1500 Above", checked: false },
    ],
  },
  {
    id: "Discount",
    ...
    options: [
      ...
      { value: "90", label: "75 - 90%", checked: false },
    ],
  },
  {
    id: "Stock",
...
export default function Product() {
  ...
  console.log("from the UI", product.products?.products?.content);
  return (
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between pb-6 pt-24 border-b border-gray-200">
            ...
            <div className="flex items-center">
              ...
              <button
                className="ml-4 p-2 text-gray-400 lg:hidden"
          ...
          <section className="w-full px-[3.6rem]">
            <div className="px-4 py-5 flex justify-center">
              <Pagination
                count={product?.products?.products?.totalPages || 1}
